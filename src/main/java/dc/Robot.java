...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(12, Sides.LEFT, true);

    CANSparkMax leftFollowerID13 = setupCANSparkMax(14, Sides.FOLLOWER, false);
    leftFollowerID13.follow(leftMotor);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(11, Sides.RIGHT, true);
    CANSparkMax rightFollowerID14 = setupCANSparkMax(13, Sides.FOLLOWER, false);
